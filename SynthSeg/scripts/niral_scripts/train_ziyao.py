...
path_training_label_maps = '/home/ziyaos/SynthSeg_seperate/training_labels'
# path of directory where the models will be saved during training
path_model_dir = '/home/ziyaos/SynthSeg_seperate/models'
prior_means = '/home/ziyaos/SynthSeg_seperate/T1merged/prior_means.npy'
prior_stds = '/home/ziyaos/SynthSeg_seperate/T1merged/prior_stds.npy'
...
dice_epochs = 2  # number of training epochs
steps_per_epoch = 50
...
training(labels_dir=path_training_label_maps,
         ...
         # load_model_file='/home/ziyaos/final/T2models/dice_030.h5'
         )
